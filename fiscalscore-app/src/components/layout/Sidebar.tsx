...
const allNavItems = [
  ...
  { href: "/dashboard/questionnaires", label: "Questionnaires", icon: FileText, adminOnly: true },
  { href: "/dashboard/evaluations", label: "Évaluations", icon: ClipboardCheck, adminOnly: false },
    ...
    <aside className="w-64 bg-white border-r border-gray-100 flex flex-col h-full shrink-0">
      <div className="px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="font-bold text-gray-900 text-sm">QHM Audit</p>
      ...
      <div className="px-3 py-4 border-t border-gray-100">
        ...
        <div className="flex items-center gap-3 px-3 py-2.5 mt-1">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-medium text-gray-900 truncate">{userName ?? 'Utilisateur'}</p>
            <p className="text-xs text-gray-400 truncate">{isAdmin ? 'Administrateur' : 'Évaluateur'}</p>
          </div>
        </div>
      </div>
    </aside>

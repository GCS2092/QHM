      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            {availableCount} questionnaires disponibles
          </p>
        </div>
        <Link
            ...
            {loading ? (
              ...
              questionnaires.map((q) => (
                <tr key={q.id} className="hover:bg-gray-50 transition">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-medium text-gray-900">
                        {q.titre ?? "Questionnaire sans titre"}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-gray-600">
                    {q.evaluations?.length ?? 0} evaluations
                  </td>
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${q.actif ? "bg-green-50 text-green-700" : "bg-gray-100 text-gray-500"}`}
                    >
